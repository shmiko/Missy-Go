...
class MainHandler(webapp2.RequestHandler):
    def get(self):
        self.response.out.write('Hello, Missy!')
        #template = jinja_environment.get_template('search.htm')
        template = jinja_environment.get_template('/home/home.htm')
        self.response.out.write(template.render())

class search_form(webapp2.RequestHandler):
    def get(self):
      template = jinja_environment.get_template('/home/search.htm')
      self.response.out.write(template.render())
